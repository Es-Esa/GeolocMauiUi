...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [21 x i8] c"com.geoloc.clientapp\00", align 1
...
@.DSOCacheEntry.2_name = private unnamed_addr constant [18 x i8] c"libonnxruntime.so\00", align 1
@.DSOCacheEntry.3_name = private unnamed_addr constant [24 x i8] c"libonnxruntime4j_jni.so\00", align 1
...
@.DSOCacheEntry.15_name = private unnamed_addr constant [16 x i8] c"libLdaNative.so\00", align 1
@.DSOCacheEntry.16_name = private unnamed_addr constant [16 x i8] c"libSkiaSharp.so\00", align 1
