package crc64f6785128ebd7585b;


public class AndroidVideoFrameService_FrameAnalyzer
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ClientApp.Platforms.Android.Services.AndroidVideoFrameService+FrameAnalyzer, ClientApp", AndroidVideoFrameService_FrameAnalyzer.class, __md_methods);
	}

	public AndroidVideoFrameService_FrameAnalyzer ()
	{
		super ();
		if (getClass () == AndroidVideoFrameService_FrameAnalyzer.class) {
			mono.android.TypeManager.Activate ("ClientApp.Platforms.Android.Services.AndroidVideoFrameService+FrameAnalyzer, ClientApp", "", this, new java.lang.Object[] {  });
		}
	}
