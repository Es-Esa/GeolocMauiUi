...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 68, ; uint32_t number_of_dso_cache_entries
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [68 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.16_name, ; name: libSkiaSharp.so
		ptr null; void* handle
	}, ; 5
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x36e1f65bc0d67d98, ; from name: LdaNative
		i64 u0x3d326f4aa44b4200, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libLdaNative.so
		ptr null; void* handle
	}, ; 13
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x3d326f4aa44b4200, ; from name: libLdaNative.so
		i64 u0x3d326f4aa44b4200, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libLdaNative.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.3_name, ; name: libonnxruntime4j_jni.so
		ptr null; void* handle
	}, ; 26
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.2_name, ; name: libonnxruntime.so
		ptr null; void* handle
	}, ; 32
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x87ddc17706e1383b, ; from name: LdaNative.so
		i64 u0x3d326f4aa44b4200, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libLdaNative.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xcabc2fe9ca5c5210, ; from name: libLdaNative
		i64 u0x3d326f4aa44b4200, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.15_name, ; name: libLdaNative.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [21 x i8] c"com.geoloc.clientapp\00", align 16
...
@.DSOCacheEntry.2_name = private unnamed_addr constant [18 x i8] c"libonnxruntime.so\00", align 16
@.DSOCacheEntry.3_name = private unnamed_addr constant [24 x i8] c"libonnxruntime4j_jni.so\00", align 16
...
@.DSOCacheEntry.15_name = private unnamed_addr constant [16 x i8] c"libLdaNative.so\00", align 16
@.DSOCacheEntry.16_name = private unnamed_addr constant [16 x i8] c"libSkiaSharp.so\00", align 16
